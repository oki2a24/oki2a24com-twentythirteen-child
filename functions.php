<?php
/**
 * 親テーマ Twenty Thirteen のセットアップに追加する処理を定義します。
 */
function oki2a24_twentythirteen_child_setup() {
...
/**
 * 親テーマ Twenty Thirteen のセットアップに処理を追加します。
 */
//add_action( 'after_setup_theme', 'oki2a24_twentythirteen_child_setup' );
